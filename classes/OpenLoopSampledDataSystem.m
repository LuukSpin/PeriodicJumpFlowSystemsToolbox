classdef OpenLoopSampledDataSystem < JumpFlowSystem
    ...
    methods
        ...
        function obj = OpenLoopSampledDataSystem(Ac, Bwc, Ad, Bwd, Bud, Czc, Dzc_wc, Czd, Dzd_wd, Dzd_u, Cy, Dy_wd, Dy_u)
            ...
            % variable. That means that this constructor accepts 0 up to 13
            % input arguments. However, no more than 13 input arguments is
            % allowed.
            arguments
                Ac = []
        ...
        function SDSystem = plus(objSD1, objSD2)
            ...
            Dzd_u = objSD1.Dzd_u+objSD2.Dzd_u;
        ...
        %   
            ...
            Czd = [obj1.Dzd_wd*obj2.Czd+obj1.Dzd_u*obj2.Cy, obj1.Czd];
            Dzd_wd = obj1.Dzd_wd*obj2.Dzd_wd+obj1.Dzd_u*obj2.Dy_wd;
            Dzd_u = obj1.Dzd_wd*obj2.Dzd_u+obj1.Dzd_u*obj2.Dy_u;
